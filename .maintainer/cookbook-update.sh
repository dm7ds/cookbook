#!/bin/bash
# =============================================================================
# Cookbook Multi-Category — Knopfdruck-Update-Script  (LÄUFT AUF PLANLOS)
# =============================================================================
...
#
# Dieses Script läuft AUF dem planlos-Server (nicht auf dem Windows-Rechner).
...
#   6. Verifikation (HTTP)
#
# Struktur auf planlos (Tools NEBEN dem Repo, damit branch-Wechsel sie nicht stören):
#   ~/cookbook-fork/
...
NC_URL="${NC_URL:-https://cloud.planlos.net}"
...
# --- PREFLIGHT ---
echo ""; step "Cookbook Multi-Category Update (planlos)"; echo ""
